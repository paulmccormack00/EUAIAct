...
export default function PrivacyModal({ onClose, onKeyDown }) {
  ...
  return (
    <div ref={trapRef} role="dialog" aria-modal="true" aria-labelledby="privacy-modal-title" onKeyDown={onKeyDown}
      ...
      <div className="modal-content" style={{ position: "relative", background: COLORS.white, borderRadius: RADIUS.round, maxWidth: 620, width: "100%", padding: "36px 40px", boxShadow: "0 25px 50px rgba(0,0,0,0.15)", maxHeight: "90vh", overflowY: "auto" }}
        ...
        <p style={{ fontSize: 13, color: "#5c4d38", margin: "0 0 24px", fontFamily: SANS }}>Last updated: April 2026</p>
        ...
        {[
          ...
          { title: "AI chat \u2014 how your data is processed", text: "When you submit a question through the AI Chat, your message is sent to a server-side function hosted on Vercel, which forwards it to Google\u2019s Gemini API to generate a response. Your question and the response are then stored in a database hosted by Supabase. This means your chat content is processed by three parties: Vercel (transmission), Google (AI processing), and Supabase (storage). We do not send any personal identifiers to these services. Google\u2019s data handling for the Gemini API is governed by their privacy policy (policies.google.com/privacy) and Gemini API terms of service. Supabase stores data on infrastructure provided by Amazon Web Services (AWS)." },
          ...
          { title: "Third-party processors", text: "We use the following third-party services which may process data in connection with this Tool: Vercel Inc. (hosting, serverless functions, and anonymous analytics \u2014 vercel.com/legal/privacy-policy), Google LLC (AI model provider via the Gemini API \u2014 policies.google.com/privacy), and Supabase Inc. (database hosting \u2014 supabase.com/privacy). No external font services, advertising networks, or social media trackers are used. Data may be transferred to and processed in the United States by these providers. Appropriate safeguards are in place through each provider\u2019s standard contractual terms." },
