          ...
          return (
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: 13, color: "#64748b", lineHeight: 1.5 }}>{criterion.help}</div>
              </div>
            </button>
          );
        })}
          ...
          return (
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 12, color: "#566b82", fontStyle: "italic" }}>e.g. {cat.examples}</div>
              </div>
              <span style={{ fontSize: 11, color: "#566b82", fontWeight: 500, flexShrink: 0 }}>{cat.articles}</span>
            </button>
          );
        })}
      </div>
          ...
          return (
            ...
            >
              ...
              <div>
                ...
                {dt.note && <div style={{ fontSize: 12, color: "#566b82", lineHeight: 1.5, fontStyle: "italic" }}>{dt.note}</div>}
              </div>
            </button>
          );
        })}
          ...
          return (
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 12, color: "#566b82", marginBottom: 6 }}>{right.charter}</div>
                <div style={{ fontSize: 13, color: "#64748b", lineHeight: 1.5, marginBottom: 4 }}>{right.description}</div>
                <div style={{ fontSize: 12, color: "#566b82", fontStyle: "italic" }}>e.g. {right.examples}</div>
              </div>
            </button>
          );
        })}
      ...
      <div className="fria-results-print">
        ...
        <div className="fria-results-grid" style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 16, marginBottom: 24 }}>
          <div style={{ padding: "20px", background: "#f8fafc", borderRadius: 12, border: "1px solid #e2e8f0" }}>
            <p style={{ fontSize: 11, color: "#566b82", textTransform: "uppercase", letterSpacing: "0.1em", fontWeight: 700, margin: "0 0 8px", fontFamily: SANS }}>Classification</p>
          ...
          <div style={{ padding: "20px", background: "#f8fafc", borderRadius: 12, border: "1px solid #e2e8f0" }}>
            <p style={{ fontSize: 11, color: "#566b82", textTransform: "uppercase", letterSpacing: "0.1em", fontWeight: 700, margin: "0 0 8px", fontFamily: SANS }}>Deployer Type</p>
          ...
          <div style={{ padding: "20px", background: risk.bg, borderRadius: 12, border: `1px solid ${risk.color}22` }}>
            <p style={{ fontSize: 11, color: "#566b82", textTransform: "uppercase", letterSpacing: "0.1em", fontWeight: 700, margin: "0 0 8px", fontFamily: SANS }}>Rights Impact</p>
          ...
          <div style={{ padding: "20px", background: "#f8fafc", borderRadius: 12, border: "1px solid #e2e8f0" }}>
            <p style={{ fontSize: 11, color: "#566b82", textTransform: "uppercase", letterSpacing: "0.1em", fontWeight: 700, margin: "0 0 8px", fontFamily: SANS }}>DPIA Reuse</p>
              ...
              return (
                <div key={right.id} style={{
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    ...
                    <span style={{ fontSize: 13, fontWeight: 500, color: impacted ? "#991b1b" : "#566b82", fontFamily: SANS }}>{right.label}</span>
                  </div>
                </div>
              );
            })}
        ...
        <div style={{ padding: "24px", background: "white", borderRadius: 12, border: "2px solid #1e3a5f" }}>
          ...
          <p style={{ fontSize: 13, color: "#64748b", margin: "0 0 16px", fontFamily: SANS }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 0" }}>
        <div style={cardStyle}>
          <div style={{ textAlign: "center", padding: "20px 0" }}>
            ...
            <p style={{ fontSize: 13, color: "#566b82", lineHeight: 1.6, maxWidth: 500, margin: "0 auto 24px", fontFamily: SANS }}>
  ...
  return (
    <div style={{ maxWidth: 780, margin: "0 auto", padding: "40px 0" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: 36 }}>
        ...
        <p style={{ fontSize: 15, color: "#64748b", lineHeight: 1.6, fontFamily: SANS }}>
      ...
      <div style={{ marginBottom: 32 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
          ...
          <span style={{ fontSize: 12, color: "#566b82", fontFamily: SANS }}>{progressPercent}%</span>
        </div>
          ...
          {STEPS.map((s, i) => (
            <button
              ...
              style={{
                ...
                borderRadius: 6, fontSize: 11, color: i <= step ? "#374151" : "#566b82",
      ...
      <div className="fria-card-inner" style={cardStyle}>
        <div style={{ marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 14, color: "#566b82", margin: 0, fontFamily: SANS }}>
            {STEPS[step].subtitle}
          </p>
        </div>
        {renderStep()}
