  ...
  return (
    <div style={{ maxWidth: "100%" }}>
      ...
      <div style={{ marginBottom: 24 }}>
        <p style={{ fontSize: 11, color: "#8b7355", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 8, fontFamily: SANS }}>CHAPTER I · Article 3</p>
      ...
      <div className="def-controls" style={{ display: "flex", gap: 12, alignItems: "center", marginBottom: 20, flexWrap: "wrap" }}>
        <div className="def-search-wrap" style={{ flex: 1, minWidth: 250, display: "flex", alignItems: "center", background: "white", border: "1.5px solid #e2e0dc", borderRadius: 10, padding: "8px 14px" }}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="2" style={{ marginRight: 10, flexShrink: 0 }}>
          ...
          <input
            ...
            style={{ flex: 1, outline: "none", border: "none", background: "transparent", fontSize: 14, fontFamily: SANS, color: "#1e293b" }}
          />
          {defSearch && (
            <button onClick={() => setDefSearch("")} style={{ background: "none", border: "none", cursor: "pointer", color: "#94a3b8", padding: 2 }}>
              ...
              return (
                <div key={def.num} style={{
                  ...
                  <button onClick={() => toggleDef(def.num)}
                    ...
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="2" style={{ flexShrink: 0, transition: "transform 0.2s", transform: isExpanded ? "rotate(180deg)" : "none" }}>
                      <path d="M6 9l6 6 6-6" />
                    </svg>
                  </button>
                  {isExpanded && (
      ...
      {filtered.length === 0 && (
        <div style={{ textAlign: "center", padding: "48px 0" }}>
          <img src={ASTRO_LOST} alt="" style={{ height: 120, opacity: 0.35, margin: "0 auto 12px", display: "block" }} />
          <p style={{ color: "#94a3b8", fontSize: 15, fontFamily: SANS }}>No definitions matching "{defSearch}"</p>
        </div>
      )}
    </div>
  );
