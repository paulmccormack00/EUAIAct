  ...
  return (
    <div style={{ maxWidth: "100%" }}>
      ...
      <div style={{ marginBottom: 24 }}>
        <p style={{ fontSize: 11, color: "#8b7355", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 8, fontFamily: SANS }}>CHAPTER II · Prohibited AI Practices</p>
